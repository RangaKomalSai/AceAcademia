...
function BenefitCard({ number, heading, subheading }) {
  return (
    <div className="flex flex-col gap-1 max-w-[250px] h-[320px] px-5 py-5 mx-2 my-2 border-2 border-light-blue shadow-xl hover:shadow-light-blue rounded-lg cursor-pointer hover:border-p-blue ">
